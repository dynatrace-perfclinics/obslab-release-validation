...
# Replace placeholders in k6 Kubernetes YAML with realtime values
sed -i "s,CODESPACE_NAME_PLACEHOLDER,$CODESPACE_NAME," .devcontainer/k6/k6-srg-training-runs.yaml
sed -i "s,GITHUB_CODESPACES_PORT_FORWARDING_DOMAIN_PLACEHOLDER,$GITHUB_CODESPACES_PORT_FORWARDING_DOMAIN," .devcontainer/k6/k6-srg-training-runs.yaml
...
kubectl create secret generic dt-details --from-literal=DT_ENDPOINT_UC14=$DT_ENDPOINT_UC14 --from-literal=DT_API_TOKEN_UC14=$DT_API_TOKEN_UC14
